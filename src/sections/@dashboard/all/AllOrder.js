...
export default function ToggleButtons() {
  ...
  const handleStatusChange = async () => {
    if(selectedType === 'divan'){
      ...
      const response = await axios.get('http://localhost:4000/api/submissions/all-devan');
      ...
      try {
        ...
        // Fetch the updated data from the server
      const response = await axios.get('http://localhost:4000/api/submissions/all-sleigh');
